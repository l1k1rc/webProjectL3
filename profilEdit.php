    ...
    <div class="header">
            ...
            <div id="resultContainer">
                ...
                <form enctype='multipart/form-data' action='profilEdit.php' method='POST' style='text-align: center;'>
                    ...
                    <img src=".$array_profil[6]['profilimgu']."  id='output' style='  box-shadow: 0 0 20px 0 rgba(0,0,0,0.5), 0 5px 5px rgba(0,0,0,0.5); border: black groove 4px; width: 150px; height: 150px; margin-left:auto; margin-right:auto;'>
                    <script>
                    ...
                    <input type='submit' name='uploadRequired' class='getProfil2' value='Mettre à jour' style='display: relative;' />
                </form>
                ...
                ?>
                <div class="compartments">
                    <p style='font-family: MANIFESTO, sans-serif; font-size: 20px; text-align: center; color: tomato; margin-bottom: 15px;'>Modifier le profil</p>
                    <?php
                    ...
                    <form action="profilEdit.php" method="POST">
                        <label for="newname" class='motImportant'>Changer nom :</label>
                        <input type="text" name="newname" style="width: 200px; height: 10px; margin-left: 33px;">
                        <br />
                        <label for="newsurname" class='motImportant'>Changer prénom :</label>
                        <input type="text" name="newsurname" style="width: 200px; height: 10px; margin-left: 10px;">
                        <br />
                        <label for="newage"class='motImportant'>Changer âge :</label>
                        <input type="text" name="newage" style="width: 200px; height: 10px; margin-left: 40px;">
                        <br />
                        <label for="newgender" class='motImportant'>Changer genre :</label>
                            <select name="newgender" id="newgender" style="width: 200px; height: 39px; margin-left: 25px;">
                              <option value="nothing">Choisir</option>
                              <option value="Homme">Homme</option>
                              <option value="Femme">Femme</option>
                            </select> 
                        <br />
                        <label for="newtel" class='motImportant'>Changer mobile :</label>
                        <input type="text" name="newtel" style="width: 200px; height: 10px; margin-left: 17px;">
                        <br />
                        <label for="newpwd" class='motImportant'>Nouveau MDP :</label>
                        <input type="text" name="newpwd" style="width: 200px; height: 10px; margin-left: 26px; margin-right: 10px;">
                        <label for="newpwd1" class='motImportant'>Confirmer MDP :</label>
