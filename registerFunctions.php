 <?php 
	...
	if (isset($_POST['enLigne2'])){
		...
		$type = str_replace("'","[\quote]",$_POST['type']);
		$title = str_replace("'","[\quote]",$_POST['titleCarPool']);
		$seat = str_replace("'","[\quote]",$_POST['places']);
		$destination = str_replace("'","[\quote]",$_POST['destination']);
		$departure = str_replace("'","[\quote]",$_POST['departure']);
		$email = str_replace("'","[\quote]",$_POST['email']);
		$price = str_replace("'","[\quote]",$_POST['price']);
		$commentary = str_replace("'","[\quote]",$_POST['commentaryArea']);
