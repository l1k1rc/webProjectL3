        ...
        <div class="header">
            ...
            <div id="resultContainer">
                ...
                <form enctype="multipart/form-data" action="registerFunctions.php" method="POST">
                    ...
                    <br />
                    <label id="carburant">Veuillez choisir le type de carburant de la voiture :</label>
                    ...
                    <br />
                    <label id="email">Veuillez saisir l'E-Mail où vous contacter :</label>
                    <input type="text" name="email" style="width: 300px; margin-left: 98px">
                    <br />
                    <label id="duree">Veuillez saisir la durée de location :</label>
                    <input type="number" name="duree" min="1" max="12" style="width: 300px; margin-left: 142px; height: 60px">
                    <label>semaines</label>
                    <br />
                    <label id="prix">Veuillez saisir le prix de la location :</label>
